...
const Options = ({selectedPlant, handleOptionsObject}) => {
  ...
  const confirmOptionsCB = () => {
    try {
      ...
      handleOptionsObject
      (plant, selectedLight, waterFreq, soilType, 
      ...
      <div className='box2'>
        ...
        <div className='options-section'>
          ...
          <div className='season-buttons'> 
            <button className='season' onClick={() => handleSeasonClick('Spring')}>Spring</button>
            <button className='season' onClick={() => handleSeasonClick('Summer')}>Summer</button>
            <button className='season' onClick={() => handleSeasonClick('Autumn')}>Autumn</button>
            <button className='season' onClick={() => handleSeasonClick('Winter')}>Winter</button>
          </div>
    ...
    <div className='box2'>
      ...
      <div className="options-section">
        ...
        <div className="radio-container">
          <input type="radio" id="welldr" name="soilType" value="Well-draining Soil" onChange={() => handleSoilTypeChange("well draining")}/>
      ...
      <div className="options-section">
        ...
        <div className="slidecontainer">
          <input type="range" min="10" max="30" value={sliderValue} className="slider" id="myRange" onChange={handleSliderChange} />
